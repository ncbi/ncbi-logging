...
UNIQIPS = "/panfs/traces01.be-md.ncbi.nlm.nih.gov/strides-analytics/uniq_ips/uniq_ips.20240517.all.json"
# 2) https://www.microsoft.com/en-us/download/details.aspx?id=56519
SERVICE_TAGS = "https://download.microsoft.com/download/7/1/D/71D86715-5596-4529-9B13-DA13A5DE5B63/ServiceTags_Public_20240513.json"
...
for value in AZURE_JSON["values"]:
    ...
    for prefix in value["properties"]["addressPrefixes"]:
        ...
        if (
            prefix.startswith("2603:1")
            or prefix.startswith("2a01:111:")
            or prefix.startswith("2602:f")
            or prefix.startswith("2620:1ec:")
        ):
