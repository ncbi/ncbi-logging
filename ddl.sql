CREATE ROLE SA_PROD_READ WITH LOGIN PASSWORD 'Al64ISK71Me1';
CREATE ROLE SA_PROD_WRITE WITH LOGIN PASSWORD '3TVYyq9MDHoE';
CREATE DATABASE STRIDES_ANALYTICS;

GRANT CONNECT ON DATABASE STRIDES_ANALYTICS TO SA_PROD_READ;
GRANT SELECT ON ALL TABLES IN SCHEMA public TO SA_PROD_READ;
GRANT ALL PRIVILEGES ON DATABASE STRIDES_ANALYTICS TO SA_PROD_WRITE;
